        ...
        <div className={styles.container}>
            <div className={styles.column}>
                <div className={styles.rateMain}>
                    <h5 className={styles.header}>Pricing</h5>
                    <p className={styles.subtitle}>Affordable Basic & Pro Plans</p>
                </div>
                <div className={styles.ratePricing}>
                    <p className={styles.price}>
                        <span className={styles.priceCurrency}></span>
                        <span className={styles.priceInfo}></span>
                    </p>
                </div>
                <div className={styles.fixedFeatures}>
                    <p>Core features</p>
                    {features && features?.length && features.length > 0 ? (
                        features.map(feature => <p>{feature.title}</p>)
                    ) : (
                        <LoadingSpinner />
                    )}
                </div>
